 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9999/test/employeeservice?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9999/test/employeeservice?wsdl");
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://service/", "EmployeeServiceImplPort"), EmployeeServiceImpl.class);
    }
    ...
    public EmployeeServiceImpl getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "EmployeeServiceImplPort"), EmployeeServiceImpl.class, features);
    }
